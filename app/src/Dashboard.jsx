...
import { getDeFiMetrics, getCrossProtocolLiquidity } from './api'; // Fixed path
import { Container, Grid } from '@mui/material'; // Fixed import
...
const Dashboard = () => {
  ...
  if (loading) {
    return <div>Loading...</div>; // You can replace this with a spinner or loader component if available
  }
